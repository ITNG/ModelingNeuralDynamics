...
num_e, num_i = 400, 100
sigma_e = 0.00
i_ext_e = 1.9 * np.ones(num_e) * (1 + sigma_e * rng.standard_normal(num_e))
sigma_i = 0.00
i_ext_i = 1.5 * np.ones(num_i) * (1 + sigma_i * rng.standard_normal(num_i))
g_hat_ee, g_hat_ei, g_hat_ie, g_hat_ii = 0., 0., 0.5, 0.5
