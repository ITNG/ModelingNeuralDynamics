...
def simulate(g_syn):
    ...
    driven by an excitatory synapse (q reset to 1 every T ms, s the usual
    two-state synaptic gate)'''
...
v_strong = simulate(0.195)
v_weak = simulate(0.14)

t_spikes_strong = spike_times(v_strong)
