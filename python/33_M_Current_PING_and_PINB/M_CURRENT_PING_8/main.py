...
g_m = 0.50  # M-current conductance; the only parameter of the neuronal
            # model, other than external drive, not explicitly written
            # into the code.
g_hat_ee, g_hat_ei, g_hat_ie, g_hat_ii = 0.35, 0.5, 0.5, 0.5
...
def simulate(g_ee, g_ei, g_ie, g_ii, i_ext_e=i_ext_e, i_ext_i=i_ext_i, t_final=t_final):
...
# drive the E_P-cells 20% harder to simulate effects of recurrent
# NMDA-receptor-mediated excitation
i_ext_e[num_e // 2:] *= 1.20

g_ee, g_ei, g_ie, g_ii = make_connectivity()
t_e_spikes, i_e_spikes, t_i_spikes, i_i_spikes = simulate(g_ee, g_ei, g_ie, g_ii)
