...
g_hat_ee, g_hat_ei, g_hat_ie, g_hat_ii = 0.25, 0.25, 0.25, 0.25
...
t_e_spikes, i_e_spikes, t_i_spikes, i_i_spikes, lfp = simulate(g_ee, g_ei, g_ie, g_ii)
...
if __name__ == "__main__":
    ...
    m_steps_final = round(t_final / dt)
    axes[1].plot(np.arange(m_steps_final + 1) * dt, lfp, '-k', linewidth=2)
