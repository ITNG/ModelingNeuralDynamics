...
frequency_of_I_cell=num_spikes_i*1000/t_final
ind1=find(i_e_spikes==1);
frequency_of_E_cell_1=length(ind1)*1000/t_final
ind2=find(i_e_spikes==2);
frequency_of_E_cell_2=length(ind2)*1000/t_final


g_ee(1,2)=0.4; g_ee(2,1)=0.4;
