...
g_hat_ii=0.5;   p_ii=1;
g_hat_gap=0.0;  p_gap=5/num_i;      % Individual gap junctions are of strength
                                    % g_hat_gap/(p_gap*(num_i-1)).
                                    % Any two differnet I-cells are gap-junctionally
...
axis([t_final-100,t_final,0,21]); 
hold on;
plot([t_final-100,t_final,t_final,t_final-100,t_final-100],[0,0,21,21,0],'-r','Linewidth',4);
hold off;
