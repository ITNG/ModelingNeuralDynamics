...
hold on;
plot([t_final-97,t_final],[0,0],'-r','Linewidth',8);
plot([t_final-100,t_final],[21,21],'-r','Linewidth',4);
plot([t_final-100,t_final-100],[0,21],'-r','Linewidth',4);
plot([t_final,t_final],[0,20],'-r','Linewidth',8);
hold off;
