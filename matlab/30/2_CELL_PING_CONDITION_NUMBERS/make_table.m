...
base_period=t_e_spikes(num_spikes_e)-t_e_spikes(num_spikes_e-1)
...
period_with_reduced_I_E=t_e_spikes(num_spikes_e)-t_e_spikes(num_spikes_e-1)
percentage_change=(base_period-period_with_reduced_I_E)/base_period*100
...
period_with_increased_g_IE=t_e_spikes(num_spikes_e)-t_e_spikes(num_spikes_e-1)
percentage_change=(base_period-period_with_increased_g_IE)/base_period*100
...
period_with_increased_tau_I=t_e_spikes(num_spikes_e)-t_e_spikes(num_spikes_e-1)
percentage_change=(base_period-period_with_increased_tau_I)/base_period*100
