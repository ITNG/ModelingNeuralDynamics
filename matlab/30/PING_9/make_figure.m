...
g_hat_ee=.25; g_hat_ei=.25; g_hat_ie=0.25; g_hat_ii=0.25; 
...
z=zeros(num_e,1); v_e=z; m_e=m_e_inf(v_e); h_e=z; n_e=z; q_e=z; s_e=z; 
for i=1:num_e,
    iv=rtm_init(i_ext_e(i),rand(1,1));
    v_e(i)=iv(1); h_e(i)=iv(2); n_e(i)=iv(3); m_e(i)=m_e_inf(v_e(i));
end;
