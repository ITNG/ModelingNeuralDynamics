...
% Repeat the simulation, this time replacing the inhibitory gating
% variabe affecting the E-cell with the time average of that variable. 

mean_s_i=mean(s_i_vec(2:m_steps+1));
