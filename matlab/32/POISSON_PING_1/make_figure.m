...
num_e=200; num_i=num_e/4;
sigma_e=0.05; i_ext_e=0.5*ones(num_e,1).*(1+sigma_e*randn(num_e,1)); 
sigma_i=0.05; i_ext_i=0.0*ones(num_i,1).*(1+sigma_i*randn(num_i,1));
...
f_stoch=60;  g_stoch=0.03;% These are the parameters defining the Poisson
...
f_hat_e=num_spikes_e/num_e/t_final*1000
f_hat_i=num_spikes_i/num_i/t_final*1000
