...
num_e=200; num_i=50;
sigma_e=0.05; i_ext_e=0.0*ones(num_e,1).*(1+sigma_e*randn(num_e,1)); 
...
z=zeros(num_e,1); w=z; q_e=z; s_e=z;
...
% solve the system of Hodgkin-Huxley-like equations using the midpoint
% method, starting where the first simulation ended
