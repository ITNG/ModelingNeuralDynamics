...
num_e=200; num_i=50;
sigma_e=0.0; i_ext_e=1.4*ones(num_e,1).*(1+sigma_e*randn(num_e,1)); 
sigma_i=0.00; i_ext_i=0.2*ones(num_i,1).*(1+sigma_i*randn(num_i,1));
g_hat_ee=0; g_hat_ei=5; g_hat_ie=0.25; g_hat_ii=0.75; 
p_ee=1; p_ei=1; p_ie=1; p_ii=1;
