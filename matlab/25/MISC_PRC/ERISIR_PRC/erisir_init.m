function erisir_init=erisir_init(i_ext,phi_vec);
...
% output: a num-by-3 array called erisir_init. The columns
%         contain values of v, h, and n. If i_ext is below
%         the firing threshold, then the points (v,h,n)
%         (the rows of the matrix erisir_init) are all equal 
...
dt=0.002; dt05=dt/2; m_steps=round(t_final/dt);
