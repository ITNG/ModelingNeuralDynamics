...
subplot(111);
plot(phi_vec,g_vec/delta_v,'-k','Linewidth',6);
set(gca,'Fontsize',24);
xlabel('$\varphi$','Fontsize',32);
ylabel('$g/\Delta v$','Fontsize',32);
hold on;
shg;

delta_v=delta_v/10;

v=initial_vector(:,1)+delta_v;
m=m_inf(v);
h=initial_vector(:,2);
n=initial_vector(:,3);
...
plot(phi_vec(10:20:N),g_vec(10:20:N)/delta_v,'.r','Markersize',50);
hold off;
shg;
