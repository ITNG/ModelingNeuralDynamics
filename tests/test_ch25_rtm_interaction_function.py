...
MATLAB_DIR = "25/RTM_INTERACTION_FUNCTION"


@pytest.mark.slow
def test_rtm_interaction_function_matches_matlab():
    # same simulation as RTM_PRC (g_syn=0.1); only the plotted quantity
    # (f = phi + g, vs. g alone) differs.
